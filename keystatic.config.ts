...
export default config({
  ...
  ui: {
    ...
    navigation: {
      ...
      content: ["roles", "skills", "education", "certifications"],
    },
  },
  singletons: {
    personal: singleton({
  ...
  collections: {
    ...
    skills: collection({
      ...
      schema: {
        ...
        unlockedBy: fields.array(
          fields.text({ label: "Prerequisite skill slug" }),
          {
            label: "Prerequisite skills",
            description:
              "Slugs of skills this one unlocks from (renders edges in the tree)",
          },
        ),
        order: fields.number({
          label: "Sort order",
