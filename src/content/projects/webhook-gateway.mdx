...
## Companion admin (Angular 19)

A second admin UI is published as a sibling repo: **[webhook-gateway-admin](https://github.com/mateokadiu/webhook-gateway-admin)** — Angular 19 with `provideExperimentalZonelessChangeDetection()`, signal-based filters, TanStack Query for Angular, and the same Zod schemas. Same backend, two frontends. See the [project page](/projects/webhook-gateway-admin/) for the writeup.
